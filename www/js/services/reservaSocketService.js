angular.module('reservasocket.service', [])


.service("ReservaSocketService", function($http, $q, SERVIDOR) {
    ...
    service.CHAT_TOPIC = "/topic/reserva";
    service.CHAT_BROKER = "/app/reserva";
